...
<div class="form-group">
    ...
    <div class="form-group w-50">
        ...
        <div class="form-group w-50">
            ...
            <input type="text" name="menu"  placeholder="isi menu" class="form-control" required>
        </div>

        <div class="form-group w-50">
            <label for="">Harga</label>
            <input type="text" name="harga" number placeholder="isi harga" class="form-control" required>
        </div>
