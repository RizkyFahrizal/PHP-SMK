...
<div class="form-group">
    ...
    <div class="form-group w-50">
        ...
        <div class="form-group w-50">
            ...
            <input type="text" name="menu"  value="<?php echo $item['menu']?> "class="form-control" required>
        </div>

        <div class="form-group w-50">
            <label for="">Harga</label>
            <input type="text" name="harga" number value="<?php echo $item['harga']?>" class="form-control" required>
        </div>
